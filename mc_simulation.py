#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Child Labor / Cost Arbitrage Floor
==================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Child Labor (Cost Arbitrage Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "child_labor",
    "domain_name": "Child Labor",
    "theorem": "Cost Arbitrage Floor",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 39.5,
    "channels": {
        "C1_human_capital": {
            "dist": "lognormal",
            "low": 381,
            ...
            "high": 537,
            "weight": 0.42,
            "description": "Foregone education, lifetime earnings loss (160M children)"
        },
        "C2_health": {
            "dist": "lognormal",
            "low": 28,
            ...
            "high": 62,
            "weight": 0.08,
            "description": "Physical injuries, chemical exposure, psychological trauma"
        },
        "C3_intergenerational": {
            "dist": "lognormal",
            "low": 89,
            "mid": 111.5,
            "high": 134,
            "weight": 0.19,
            "description": "Intergenerational poverty transmission"
        },
        "C4_demographic": {
            "dist": "lognormal",
            "low": 97,
            ...
            "high": 215,
            "weight": 0.18,
            "description": "Demographic dividend foreclosure"
        },
        "C5_supply_chain": {
            "dist": "lognormal",
            "low": 22,
            ...
            "high": 52,
            "weight": 0.06,
            "description": "Supply chain governance failure, audit theater"
        },
        "C6_institutional": {
            "dist": "lognormal",
            "low": 35,
            ...
            "high": 75,
            "weight": 0.07,
            "description": "Structural impunity, enforcement deficit"
        }
    },
    "impossibility_floor": 2.0
}
